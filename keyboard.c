...
// Сканирует клавиатуру раз в ~100 мс и возвращает НОВОЕ нажатие
// (одно нажатие -> один символ на выходе, без дребезга и повторов,
// пока клавиша удерживается). Если ничего нового не нажато — возвращает '\0'.
char scanKeyboard() {
  char newKey = '\0';
